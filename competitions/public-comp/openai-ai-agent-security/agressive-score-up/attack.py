...
# 0.975 -> 0.98 adds another 45 s of replay budget per run.
# This is a controlled high-cap shot: same v38 logic, slightly less replay margin.
...
class AttackAlgorithm(AttackAlgorithmBase):
    ...
    def _fill(self, env: Any, budget: float, max_hops: int) -> list[AttackCandidate]:
        ...
        print(
            "[r9_dimong_v38_hot98] returned=%d replay=%.0f/%.0f slowest=%.2f warmup=%s"
