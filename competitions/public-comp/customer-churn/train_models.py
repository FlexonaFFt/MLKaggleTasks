...
# Load data
train = pd.read_csv(PROJECT_DIR / "featured_train.csv")
test = pd.read_csv(PROJECT_DIR / "featured_test.csv")
...
# Save results
with (PROJECT_DIR / "model_results.json").open("w", encoding="utf-8") as f:
