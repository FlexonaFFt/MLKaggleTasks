...
Current prepared branch: `--r4-control-selected-pilkplain`, the clean control version of `--r3-selected-seed-pilkplain`.
...
| 2026-07-23 | `--r4-control-selected-pilkplain` | pending | prepared | same-day control for R4 |
